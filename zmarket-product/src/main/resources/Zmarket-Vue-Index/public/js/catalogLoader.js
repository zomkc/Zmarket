...
// async function json(){
//     const res = await axios.get( 'http://localhost:88/api/product/page')
//     console.log(res);
// }
$(function(){
    // $.getJSON("../json/catalog.json",function (data) {
    $.getJSON("http://localhost:88/api/product/index/catalog.json",function (data) {
        var ctgall=data;
                ...
                $.each(ctgnumArray,function (i,ctg1Id) {
                    ...
                    $.each(ctg2list,function (i,ctg2) {
                        ...
                        $.each(ctg3List,function (i,ctg3) {
                            var cata3link = $("<a href=\"http://localhost:88/product/page?catalog3Id="+ctg3.id+"\" style=\"color: #999;\">" + ctg3.name + "</a>");
                            li.append(cata3link);
