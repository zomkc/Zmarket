...
import com.zomkc.product.feign.SeckillFeignService;
import com.zomkc.product.service.*;
import com.zomkc.product.vo.SeckillSkuVo;
...
import com.zomkc.product.dao.SkuInfoDao;
...
//        CompletableFuture<Void> seckillFuture = CompletableFuture.runAsync((res) -> {
